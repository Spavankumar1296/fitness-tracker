...
export const getMe = (token) => {
  return fetch(`${process.env.REACT_APP_BASE_URL}/api/user/me`, {
    headers: {
...
export const createCardio = (cardioData, token) => {
  return fetch(`${process.env.REACT_APP_BASE_URL}/api/exercise/cardio`, {
    method: "POST",
    headers: {
      'Content-Type': 'application/json',
      authorization: `Bearer ${token}`,
...
export const createResistance = (resistanceData, token) => {
  return fetch(`${process.env.REACT_APP_BASE_URL}/api/exercise/resistance`, {
    method: "POST",
    headers: {
      'Content-Type': 'application/json',
      authorization: `Bearer ${token}`,
...
export const getCardioById = (cardioId, token) => {
  return fetch(`${process.env.REACT_APP_BASE_URL}/api/exercise/cardio/${cardioId}`, {
    headers: {
      'Content-Type': 'application/json',
      authorization: `Bearer ${token}`,
    }
...
export const getResistanceById = (resistanceId, token) => {
  return fetch(`${process.env.REACT_APP_BASE_URL}/api/exercise/resistance/${resistanceId}`, {
    headers: {
      'Content-Type': 'application/json',
      authorization: `Bearer ${token}`,
    }
